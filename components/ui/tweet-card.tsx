...
export const ClientTweetCard = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-fit w-full flex-col gap-4 overflow-hidden rounded-xl border border-border bg-card p-5 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 dark:border-border dark:bg-card dark:hover:bg-muted/50",
        className,
      )}
      {...props}
    >
        ...
        <div className="flex items-start space-x-4 w-full">
          <div className="shrink-0 mt-1">
            <img
              ...
              width={56}
              src={avatarUrl}
              className="border-border/50 overflow-hidden rounded-md border size-14 object-cover"
            />
          </div>
          <div className="flex flex-col gap-1 w-full min-w-0">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full">
              <span className="text-foreground text-2xl font-bold truncate">
                {name}
              </span>
              <span className="text-foreground text-base font-bold sm:text-right whitespace-nowrap hidden sm:block">
                {period}
              </span>
            </div>
            ...
            <span className="text-foreground text-base font-bold sm:hidden block mt-0.5">
              {period}
            </span>
          </div>
        </div>
      </div>
      <div className="text-base leading-relaxed tracking-normal text-muted-foreground/90">
        {description}
      </div>
    </div>
  );
