  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          aria-hidden
          className="absolute -bottom-24 -right-24 w-96 h-96 rounded-full bg-secondary/10 blur-3xl"
        />
          ...
          <div className="grid lg:grid-cols-2 items-center gap-8 lg:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
                Hello! I&apos;m <span className="text-primary">Hao Jun</span>
                <br />
              </h1>
              ...
              <div className="flex flex-wrap gap-3 mt-10">
                <Link
                  href="https://www.linkedin.com/in/hao-jun-mah-7b22b7210"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition"
                >
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-2.5 border border-border rounded-md hover:bg-muted transition"
                >
                  <Icons.github className="w-4 h-4" />
                </Link>
                <Link
                  href="/MAH HAO JUN RESUME.pdf"
                  download="Haojun_Mah_Resume.pdf"
                >
            ...
            description={
              <div className="space-y-1 mt-2">
                {education.description.map((desc, i) => (
                  <p key={i} className="text-foreground/80 font-medium">
                    {desc}
                  </p>
                ))}
              </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6 text-center">
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-muted-foreground text-sm sm:text-base md:text-lg lg:text-base xl:text-lg px-4">
              I have experience with various technologies across web and mobile
              development. Here are some of my favourites.
            </p>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 mb-16 sm:mb-20">
        <div className="bg-gradient-to-br from-primary/10 via-transparent to-secondary/10 border border-border rounded-2xl p-6 sm:p-8 lg:p-10 text-center">
          ...
          <div className="mt-4 sm:mt-6">
            <Link
              href="mailto:mahhaojun03@gmail.com"
              className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition text-sm sm:text-base"
            >
              Contact Me
            </Link>
          </div>
